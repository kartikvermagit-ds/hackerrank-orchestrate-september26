...
print(f"{'REQ_ID':<11} | {'GT_SAFE':<10} | {'PRE_PAY_HEAD':<12} | {'DIFF':<10}")
print("-" * 50)
...
for req in r:
    ...
    for rx in st.recurring_expenses:
        ...
        # Check if rx occurs between req_date and next_payday_dt
    ...
    print(f"{req.request_id:<11} | {gt_safe:<10.2f} | {pre_payday_headroom:<12.2f} | {pre_payday_headroom - gt_safe:<10.2f}")
